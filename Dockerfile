...
COPY certs/rds-combined-ca-bundle.pem /etc/rds-certs/rds-combined-ca-bundle.pem

RUN echo keytool $KEYTOOL_PASSWORD
RUN keytool -noprompt -storepass changeit -import -alias rds -keystore $JAVA_HOME/lib/security/cacerts -file /etc/rds-certs/rds-combined-ca-bundle.pem
