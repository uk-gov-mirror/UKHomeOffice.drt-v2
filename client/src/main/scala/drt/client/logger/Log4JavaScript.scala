...
class L4JSLogger(jsLogger: JSLogger) extends Logger {
  ...
  private var ajaxAppender: AjaxAppender = _
  ...
  */
  ...
  @elidable(FINE) override def debug(msg: String, e: Exception): Unit = jsLogger.debug(msg, undefOrError(e))

  @elidable(FINE) override def debug(msg: String): Unit = jsLogger.debug(msg)

  @elidable(INFO) override def info(msg: String, e: Exception): Unit = jsLogger.info(msg, undefOrError(e))

  @elidable(INFO) override def info(msg: String): Unit = jsLogger.info(msg)

  @elidable(WARNING) override def warn(msg: String, e: Exception): Unit = jsLogger.warn(msg, undefOrError(e))

  @elidable(WARNING) override def warn(msg: String): Unit = jsLogger.warn(msg)

  @elidable(SEVERE) override def error(msg: String, e: Exception): Unit = jsLogger.error(msg, undefOrError(e))

  @elidable(SEVERE) override def error(msg: String): Unit = jsLogger.error(msg)

  @elidable(SEVERE) override def fatal(msg: String, e: Exception): Unit = jsLogger.fatal(msg, undefOrError(e))

  @elidable(SEVERE) override def fatal(msg: String): Unit = jsLogger.fatal(msg)
