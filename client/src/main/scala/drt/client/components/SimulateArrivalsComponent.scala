...
import io.kinoplan.scalajs.react.material.ui.core.styles.StyleSheet
import japgolly.scalajs.react._
import japgolly.scalajs.react.vdom.all.{`type`, autoFocus, id, onClick}
import japgolly.scalajs.react.vdom.html_<^._

import scala.scalajs.js.JSConverters._
import scala.util.{Success, Try}
import io.kinoplan.scalajs.react.material.ui.core.{MuiButton, MuiDialog, MuiDialogActions, MuiDialogContent, MuiDialogContentText, MuiDialogTitle, MuiFab, MuiTextField}
...
object SimulateArrivalsComponent {
  ...
  val component = ScalaComponent.builder[Props]("ArrivalSimulations")
    ...
    .renderPS { (scope, props, state) =>
      ...
      def handleClickOpen = scope.modState(_.handleClickOpen)

      def handleClickClose: Callback = scope.modState(_.handleClickClose)
      ...
      <.div(<.div(<.h2("Arrival Simulations")),
        MuiFab(variant = MuiFab.Variant.extended)(
          ^.aria.label := "Delete",
          MuiIcons(MuiIconsModule.Create)(),
          onClick --> handleClickOpen,
          "Configure Simulation"
        ),
        MuiDialog(open = state.displayDialogue, onClose = onClose, fullWidth = true, maxWidth = "xl")(
          ^.aria.labelledBy := "form-dialog-title",
          MuiDialogTitle()(id := "form-dialog-title", "Configure DRT Simulation"),
          MuiDialogContent()(
            MuiDialogContentText()(
              "Enter the config parameters to see what affect it would have on the expected workload."
            ),
            <.div(^.className := "row",
